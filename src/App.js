...
useEffect(()=>{
  ...
  return (
    ...
    <div id="App">
      <Switch>
        <Route exact path ='/'><Login getUser={getUser} setToken={setToken}></Login></Route>
        <Route path ='/home-page'><HomePage candidates={candidates} selectCandidate={selectCandidate} ></HomePage></Route>
        <Route path='/admin-page'> <Admin reports={reports} toggleModal={toggleModal} openModal={openModal} selectReport={selectReport} modalData={modalData} user={user} fetchReports={fetchReports}></Admin></Route>
